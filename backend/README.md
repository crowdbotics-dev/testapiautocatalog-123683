...
## Project Structure
    ...
    ├── testapiautocatalog_123683  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_123683`
...
2. Clone this repo and `cd testapiautocatalog_123683`
